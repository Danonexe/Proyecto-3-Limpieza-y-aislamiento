...
### Medida 1: Permisos estrictos en /boot
...
### Medida 2: Sysctl Hardening del kernel
...
### Medida 3: Montaje de /proc con hidepid=2
...
### Medida 4: LKRG (Linux Kernel Runtime Guard) **EXTRA**
